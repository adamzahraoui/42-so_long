...
{
    if ((data->str[data->y - 1][data->x] == '0' || data->str[data->y - 1][data->x] == 'C'|| data->str[data->y - 1][data->x] == 'E') && data->makla > 0)
    {
    ...
    else if ((data->str[data->y - 1][data->x] == '0' || data->str[data->y - 1][data->x] == 'E') && data->makla <= 0)
    {
...
{
    if ((data->str[data->y][data->x+1] == '0' || data->str[data->y][data->x+1] == 'C' || data->str[data->y][data->x+1] == 'E') && data->makla > 0)
    {
    ...
    else if ((data->str[data->y][data->x+1] == '0' || data->str[data->y][data->x+1] == 'E') && data->makla <= 0)
    {
